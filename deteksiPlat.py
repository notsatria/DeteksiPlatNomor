...
plateCascade = cv2.CascadeClassifier("D:\\Python Projects\\License Plate Project\\haarcascade_russian_plate_number.xml")
...
while True:
    ...
    if k%256 == 27:
        ...
        cv2.imwrite("D:\Python Projects\License Plate Project\data\data"+str(count)+".jpg", imgRoi)
